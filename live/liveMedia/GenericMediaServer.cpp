...
void GenericMediaServer::addServerMediaSession(ServerMediaSession* serverMediaSession) {
  ...
  //fprintf(stderr, "Ok, ADDSERVERMEDIASESSION: %s\n", sessionName);
...
void GenericMediaServer::incomingConnectionHandlerOnSocket(int serverSocket) {
  //fprintf(stderr, "                   Generic Media Server incomingConnectionHandlerOnSocket\n");
...
GenericMediaServer::ClientSession* GenericMediaServer::createNewClientSessionWithId() {
  ...
  //fprintf(stderr, "createNewClientSessionWithId()\n");
