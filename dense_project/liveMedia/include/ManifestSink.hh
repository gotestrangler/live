...
class ManifestSink: public MediaSink {
public:
  static ManifestSink* createNew(UsageEnvironment& env, char const* fileName,
...
protected:
  ManifestSink(UsageEnvironment& env, FILE* fid, unsigned bufferSize,
	   char const* perFrameFileNamePrefix);
      // called only by createNew()
  virtual ~ManifestSink();
